package com.example.beibei.selectindexablerv.view.SelectIndexableRv;

import android.support.v7.widget.RecyclerView;
import android.view.View;
import android.view.ViewGroup;

import com.example.beibei.selectindexablerv.view.SelectIndexableRv.database.HeaderFooterDataObservable;
import com.example.beibei.selectindexablerv.view.SelectIndexableRv.database.HeaderFooterDataObserver;
import com.example.beibei.selectindexablerv.view.SelectIndexableRv.database.IndexBarDataObservable;
import com.example.beibei.selectindexablerv.view.SelectIndexableRv.database.IndexBarDataObserver;
...
abstract class AbstractHeaderFooterAdapter<T> {
    ...
    public abstract void onBindContentViewHolder(RecyclerView.ViewHolder holder, T entity,int position);
